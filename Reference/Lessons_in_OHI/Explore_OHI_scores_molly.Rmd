...
# Before even starting, we needed to make sure we were invited to the repository and that we were logged into Github through the RStudio server. My username is "mollywillams", not mollywilliams >.< Now that I'm able 
