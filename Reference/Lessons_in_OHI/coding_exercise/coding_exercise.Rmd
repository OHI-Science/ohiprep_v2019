...
You will have 24 hours to complete this activity. You will work directly in this document, using code chunks (gray parts) to wrangle, analyze, and visualize data according to the instructions. (NOTE: all code *must* be in the gray code chunks)

As necessary, provide responses to questions as well as any notes you make to document your workflow.  This information can be included in the code chunks and/or in the text of the Rmarkdown file.  
...
## do an initial exploration of the data (i.e., what functions do you use to become familiar with a dataset):
