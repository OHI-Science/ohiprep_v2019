---
title: 'Eastern Tropical Pacific: High Seas'
...
* Use the ```{r}here``` [package](https://github.com/jennybc/here_here) to standardize file paths
...
![](figures/Workspace.jpg)
  ...
  * Do you get the same results (we love ```{r}git2r``` to get previous versions of data)?
  * Be sure to check the NA's!
  * Review warnings
* External review of complex sections!