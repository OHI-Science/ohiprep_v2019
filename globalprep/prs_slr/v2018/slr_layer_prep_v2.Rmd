...
userpasswd <- readline("Type AVISO username and password, separated by colon no space:") ##comment out when knitting
```
...
ub <- sprintf("ftp://%s@%s", userpasswd, substr(url, 7, 80)) ##comment out when knitting
