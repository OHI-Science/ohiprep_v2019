...
headheadforeach(yr = years) %dopar%{ #yr = 2014
  
  #read in raw data for the year
  raw <- readRDS(paste0(file.path(dir_M,'git-annex/impact_acceleration/stressors/comm_fish/int/catch_annual_data/catch_data_2012.rds'))
...
```{r}
#read in raw data for the year
  raw <- readRDS(paste0(file.path(dir_M,'marine_threats/impact_acceleration/stressors/comm_fish/int/catch_data_2012.rds')))
