...
registerDoParallel(2) #registering cores for parallel processing
...
for(blast_catch in blast_rasts){ # blast_catch = blast_rasts[1]

cat(blast_catch)
catch_year <- str_sub(blast_catch)
...
write.csv(blast_rgn, sprintf("globalprep/np_prs_poison_blast_fishing/v2018/int/blast_catch_rgn_%s.csv", catch_year), row.names=FALSE)
