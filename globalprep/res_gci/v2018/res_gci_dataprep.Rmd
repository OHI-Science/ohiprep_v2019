...
Gapfilling for this resilience layer consists of three steps:
...
```{r gapfill II, using un georegions}
...
summary(wef)
length(unique(wef$rgn_id)) # check; should be 220 regions
```
