...
# Non-matched regions: Eswatini (landlocked), Isle of Man (not reported in OHI), North Macedonia (landlocked), West Bank/Gaza (disputed)
...
ggplotly(ggplot(sani_complete_old, aes(x = basic_sani_prop, y = basic_sani_prop_2018, labels = rgn_id)) +
  geom_point() +
...
ggplotly(ggplot(unsani_prs_old, aes(x = pressure_score, y = pressure_score_2018, labels = rgn_id)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, color = "red"))
...
ggplotly(ggplot(compare, aes(x = trend, y = trend_2018, labels = rgn_id)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, color = "red"))
