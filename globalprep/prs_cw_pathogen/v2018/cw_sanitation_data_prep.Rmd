...
year <- min(sani_gf_lm$year):max(sani_gf_lm$year)
...
#Gapfill 3 - Regions with Administrative countries?????
There are 7 regions still with no data. All of them have an administrative country.
Should we gapfill using th administrative country data?
