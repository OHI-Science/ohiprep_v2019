...
#Note: there is a difference between the list of islands with no population in the mar_pop_25mi dataset witht the nhabit list in github. In the mar_pop_25mi, rgn_id 144 - Jan Mayen is not identified as a pop_0 region qhile in the github list it is.
