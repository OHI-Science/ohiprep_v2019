...
#write.csv(pop_density, "inter/pathogen_pop_density_25mi.csv", row.names=FALSE)
...
unsani_pop <- sani_complete %>%  
    ...
    left_join(pop_density, 
              by=c('rgn_id', 'year')) %>%
    mutate(propWO_x_pop     = (1 - basic_sani_prop) * pop_per_km2, # this is the population density of people without access (WO)
