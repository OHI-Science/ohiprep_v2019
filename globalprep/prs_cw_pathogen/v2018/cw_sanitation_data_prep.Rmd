...
sani_raw <- read.csv(file.path(dir_M, 'git-annex/globalprep/_raw_data/WHO_UNICEF/d2018/JMP_2017_WLD.csv'), na.strings = c(NA, ''), skip = 3, stringsAsFactors = FALSE) 

sani_raw <- read.csv(paste(dir_data, "JMP_2017_WLD.csv", sep = ""), na.strings = c(NA, ''), skip = 3, stringsAsFactors = FALSE)

#ERROR
#In file(file, "rt") :cannot open file '/home/shares/ohi/git-annex/globalprep/_raw_data/WHO_UNICEF/d2018/JMP_2017_WLD.csv': No such file or directory
