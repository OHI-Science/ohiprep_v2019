...
#Min and max year of data to calculte pressure scores
...
write.csv(unsani_pop, "output/po_pathogen_popdensity25mi.csv", row.names=FALSE)
```
...
```{r}
new <- read.csv("/output/pathogens_popdensity25mi_trend_2018a.csv")

old <- read.csv("../v2016/data/pathogens_popdensity25mi_trend_updated.csv") %>%
