...
No changes to methods from previous assessment. The file structure on the FTP website has changed slightly. 
...
monthly. For final daily data, there is also one directory for each year of available data. For example, all of the north daily data for 1990 are in a directory named /nsidc0051_gsfc_nasateam_seaice/final-gsfc/north/daily/1990/. For the monthly data, the file structure has slightly changed with the addition of 2018 data. Instead of adding the files onto the bottom of the page with this file structure "/DATASETS/nsidc0051_gsfc_nasateam_seaice/final-gsfc/south/monthly/", they have added a "2018 folder, so to retrieve the 2018 data, we will have to access that folder via "/DATASETS/nsidc0051_gsfc_nasateam_seaice/final-gsfc/south/monthly/2018/". 
...
final.year <- 2018 # final year of data (all months); double check nsidc0051 monthly dataset was updated at ftp://sidads.colorado.edu/pub/DATASETS/
...
#ub.n.2018 <- "ftp://sidads.colorado.edu/pub/DATASETS/nsidc0051_gsfc_nasateam_seaice/final-gsfc/north/monthly/2018"
#ub.s.2018 <- "ftp://sidads.colorado.edu/pub/DATASETS/nsidc0051_gsfc_nasateam_seaice/final-gsfc/south/monthly/2018"

ub.n <- file.path(dir_M, "git-annex/globalprep/_raw_data/NSIDC_SeaIce/v2019/north")
ub.s <- file.path(dir_M, "git-annex/globalprep/_raw_data/NSIDC_SeaIce/v2019/south")

#poles = c("n","s", "n_2018", "s_2018")
poles = c("n","s")
