...
old <- read.csv("../v2017/output/hab_ice_health_eez.csv") %>% # compare to last year's data
...
old <- read.csv("../v2017/output/hab_ice_trend_eez.csv") %>%
...
old <- read.csv("../v2017/output/hab_ice_extent_eez.csv") %>%
