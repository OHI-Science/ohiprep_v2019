---
title: "OHI 2019: Food Provision, Calculating fisheries stock status"
...
saveRDS(cmsy_fits, file = file.path(dir_M,"git-annex/globalprep/fis/v2019/int/cmsy-fits.rds"))
...
```{r}
cmsy_fits <- readRDS(file.path(dir_M,"git-annex/globalprep/fis/v2019/int/cmsy-fits.rds"))
