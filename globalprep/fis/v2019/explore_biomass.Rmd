...
plot(tbmsy_ssbmsy$TBdivTBmsy, tbmsy_ssbmsy$SSBdivSSBmsy)
abline(0,1, col = "red")
...
plot(TB_msy_mgt$TBdivTBmsy, TB_msy_mgt$TBdivTBmgt)
abline(0,1, col = "red")
...
plot(ssb_msy_mgt$SSBdivSSBmsy, ssb_msy_mgt$SSBdivSSBmgt)
abline(0,1, col = "red")
...
plot(tbmgt_ssbmgt$TBdivTBmgt, tbmgt_ssbmgt$SSBdivSSBmgt)
abline(0,1, col = "red")
...
plot(tbmsy_ssbmgt$TBdivTBmsy, tbmsy_ssbmgt$SSBdivSSBmgt)
abline(0,1, col = "red")
