...
# 147,269 catch data without fao regions assigned - v2018
...
summary(output_df) # FAO ID 29,703 NAs - v2018
                   # FAO ID 25,866 NAs - v2019
...
## add the taxon_resilence data to catch for b/bmsy calculations
taxon_res = read_csv('int/taxon_resilience_lookup.csv') %>%
              dplyr::select(CommonName=common, Resilience)

```

## More Wrangling
 - We must add the resilience information to the stks dataframe created above, and re write it to the output folder. 
