...
For future reference: save stocks using management (B/Bmgt) reference points instead of max sustainable yield (B/Bmsy).  Consider using management B/Bmsy values in next year's assessment.
...
## Get all the gapfilling factored in
...
setdiff(ram_spatial$stockid, ram_meta$stockid) # make sure all the spatial data has corresponding metadata (should be 0); 5 diff
