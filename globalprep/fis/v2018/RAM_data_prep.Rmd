...
load(file.path(dir_M, "git-annex/globalprep/_raw_data/RAM/d2018/RAM v4.41 (8-20-18)/DB Files With Assessment Data/DBdata (assessment data only).RData"))
...
Here we identify the FAO/OHI regions where each RAM stock is located. This step is completed in fao_ohi_rgns.Rmd.
