...
# Initial Exploration of RAM v4.40 and RAM v3.80 Differences
...
# Investigate Multiple `assessid` in RAM v4.40 Database
...
length(unique(nas$stock_id)) #58
length(unique(nas$stockid_ram)) #70
length(unique(nas$rgn_id)) #41
```
