...
Catch data now goes from 1950 - 2014. Previously catch data was only available through 2014.
...
output_df <- readRDS(df) %>%
        dplyr::select(year, taxon_scientific_name, taxon_common_name, cell_id, catch_sum, taxon_key) %>%
