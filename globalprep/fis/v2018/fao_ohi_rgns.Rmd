...
Note: the species present in the old data but not the new are due to changes in stockid names. See Stock Change History (6-1-18).xlsx file in MAZU RAM raw data folder.
...
## filter out the stocks that are no longer in the RAM data
...
# make areas equal weight (don't have better information)
RAM_rgns_new_final$RAM_area_m2 <- 1
...
ram_all <- read.csv("int/RAM_fao_ohi_rgns.csv")
