...
fasterize_py <- fasterize::fasterize(v6_seagrass_py_moll, raster = zones, 
                                     ...
                                     filename = file.path(dir_M, "/git-annex/globalprep/hab_seagrass/v2019/int/py_seagrass_rast.tif"), overwrite=TRUE) 
...
###NOTE: change these to save directly and then read in. file.path should be in the raster::calc() fxn
