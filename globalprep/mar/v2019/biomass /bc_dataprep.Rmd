...
scenario_bc <- 'v2017'
dir_git_bc  <- path.expand('~/github/ohibc')
dir_goal_bc <- file.path(dir_git_bc, 'prep', goal, scenario_bc)
dir_spatial_bc <- file.path(dir_git_bc, 'prep/_spatial')
  
  ohibc_rast <- raster(file.path(dir_spatial_bc, 'raster/ohibc_rgn_raster_1000m.tif'))
