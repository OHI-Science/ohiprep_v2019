...
PhiAreaChlDF<-read.csv("/TableDataOutputs/FinalNoHypox/CountryProdPotentialLT12.csv")
...
FishPhiALLConstraints=raster("~/Spatial_Data/NewLayersWOHypoxia/FishPhiALLConstraints95LT2.tif")
