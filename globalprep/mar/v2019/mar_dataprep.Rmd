...
## 3763 of these out of 27797+3763 cases had NA values converted to 0 - 2019 assessment
```
...
exclude <- read.csv("../v2018/output/GenEsc.csv") %>%
  filter(year == 2016) %>% # compare the most recent shared year between old and new
