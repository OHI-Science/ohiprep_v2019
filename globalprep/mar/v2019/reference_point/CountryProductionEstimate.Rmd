---
title: "CountryProductionEstimate"
author: "Gage Clawson"
date: "7/8/2019"
...
#productionStack <- raster::stack(OHIcountries_raster, areaPerCell, FishPhiALLConstraints, FishYears)
#productionVector <- getValues(productionStack)
...
#write.csv(productionDFFishCells, file.path(dir_M, "git-annex/globalprep/mar/v2019/int/productionDFFishCells.csv"))
...
#write.csv(CountryProdSummaryFAO, file.path(dir_M, "git-annex/globalprep/mar/v2019/int/CountryProdSummaryFAO_Fish.csv"))
```
