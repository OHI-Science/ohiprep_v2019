...
bivperfarm <- 130000000 #MRF: again, should units should be bivperkm2?  (100 longlines/km2) * 4 km * (100 bivalves seeded/0.0003 km) = 133333333 bivalve/km2
...
write.csv(productionDFFishCells, file.path(dir_M, "git-annex/globalprep/mar/v2019/int/fish/productionDFFishCells.csv"))
...
write.csv(productionByCountryFishDF,file.path(dir_M, "git-annex/globalprep/mar/v2019/int/fish/FishProdByCountryByCell.csv"))
productionByCountryFishDF <- read.csv(file.path(dir_M, "git-annex/globalprep/mar/v2019/int/fish/FishProdByCountryByCell"))
...
write.csv(CountryProdSummary, file.path(dir_M, "git-annex/globalprep/mar/v2019/output/FishProdByCountrySummary.csv"))
...
write.csv(CountryProdSummaryFAO, file.path(dir_M, "git-annex/globalprep/mar/v2019/output/FishCountryProdSummaryFAO.csv"))
```
...
write.csv(productionDFBivCells, file.path(dir_M, "/git-annex/globalprep/mar/v2019/int/productionDFBivCells.csv"))          
productionDFBivCells <- read.csv(file.path(dir_M, "/git-annex/globalprep/mar/v2019/int/productionDFBivCells.csv"))
...
write.csv(productionByCountryBivDF,file.path(dir_M, "git-annex/globalprep/mar/v2019/int/bivalve/BivProdByCountryByCell.csv"))
...
write.csv(CountryProdSummary,file.path(dir_M, "git-annex/globalprep/mar/v2019/output/BivalveProdByCountrySummary.csv"))
...
write.csv(CountryProdSummaryFAO, file.path(dir_M, "git-annex/globalprep/mar/v2019/output/BivalveProdByCountryFAOSummary.csv"))
