...
harvest_tonnes <- read_csv("/home/sgclawson/github/ohiprep_v2019/globalprep/mar/v2019/output/mar_harvest_tonnes.csv")  

  #sustainability_score <-
  #  AlignDataYears(layer_nm = "mar_sustainability_score", layers_obj = layers)

sustainability_score <- read_csv("/home/sgclawson/github/ohiprep_v2019/globalprep/mar/v2019/output/mar_sustainability.csv")
...
pot_aq_final <- read_csv(file.path(dir_git_ref, "/production_output/aq_potential_final.csv"))
  ...
  rky <- tidyr::gather(rky, "year", "tonnes",-(1:4)) %>%
  ...
  ry = m %>%
    ...
    dplyr::left_join(pot_aq_final, by = 'rgn_id') %>%
    dplyr::mutate(mar_pop = (sust_tonnes_sum / potential_mar_tonnes)*100) %>%
    dplyr::ungroup()
  
#### Stopped here July 10 ####  
