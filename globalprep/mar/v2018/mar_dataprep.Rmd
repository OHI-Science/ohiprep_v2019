...
# mar <- filter(mar, exclude_no_nei==0)
...
plot(compare$prs_score_old.x, compare$prs_score_old.y);abline(0,1,col="red")
...
plot(test$Maric_sustainability.x, test$Maric_sustainability.y);abline(0,1,col="red")


## Compare new/old genetic escapees scores
plot(test$Genetic.escapees.x, test$Genetic.escapees.y);abline(0,1,col="red")
