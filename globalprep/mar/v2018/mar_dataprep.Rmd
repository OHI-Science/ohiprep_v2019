...
## Data check
Comparing this year's data to previous year's data. Expect small variation from year to year. Add a plot below test to view differences.
```{r}
old <- read.csv("../v2017/output/GenEsc_v2016.csv") %>%
