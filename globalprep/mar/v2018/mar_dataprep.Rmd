...
New year of FAO mariculture yield data for 2016. No changes to sustainability. Check for changes in genetic escapee data or general methods. We will be updating our approach to reference points. All the reference point calculations occur in the ohi-global toolbox.
...
**Check to see where there are discrepancies (no matches) between Trujillo sustainability FAO spp (sus_rgn) to the FAO mariculture species in the wrangled FAO Aquaculture Production data table (maric)**
