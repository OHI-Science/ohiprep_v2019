...
#when using "select()" we receive an error. I believe this is because of a package conflict. Specify dplyr::select() whenever using hte function. 
...
#### TODO change dir_git to dir_goal whenever seen ####
dir_goal <- here('globalprep', goal, scenario)

### provenance tracking
library(provRmd); prov_setup() #delete if not needed 

### goal specific folders and info
#### TODO: change dir_O to dir_M and dir_o_anx to dir_goal_anx whenever seen ####
...
### Always check how many observations there after a join. 2019: 13404
