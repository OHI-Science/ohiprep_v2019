...
## define path names where data will be written to and/or read from
...
un_popdata_filepath <- paste0("git-annex/globalprep/_raw_data/UnitedNations_population/", scenario_yr, "/")
...
globalrgn_filepath <- "git-annex/Global/NCEAS-Regions_v2014/data" # change to reflect most recent data (d) and current assessment year (v)
```
...
## reason for not looping this to shorten the code (slower)?
