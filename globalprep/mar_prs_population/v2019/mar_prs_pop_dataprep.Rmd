...
raw # check that this looks correct; what would indicate that it is/is not correct?
...
# this line takes a while to run - ran for 30+ min and still didn't finish?
...
# these functions aren't working - am I typing the syntax wrong or is it missing something?? 
# Error message:  Error in if (x == "" | x == ".") { : argument is of length zero 
...
# same error message as 201-205 lines above - what is supposed to be happening here?
...
## currently isn't finding anything; should I move the files over from v2018? 
...
## Load EEZ + 25-mile Inland Raster and Shapefile
...
plot(eez_25mi_inland) # this doesnt really make sense... what do the numbers mean? need to dig into this 
