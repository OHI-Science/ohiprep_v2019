...
# these functions aren't working - might be in a package that's not installed?
...
# raster
eez_25mi_inland <- raster(file.path(dir_M, "git-annex/globalprep/mar_prs_population/v2018/int/eez_25mi_inland.tif"))
