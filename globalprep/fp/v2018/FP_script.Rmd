...
setwd(here::here("globalprep","fp","v2018"))
...
fis <- read.csv("../../fis/v2018/output/FP_fis_catch.csv") %>%
...
* Appears that Bouvet Island (rgn id 105) has 0 catch for all years of catch data (last available year of data from ~1988 so newer years are gapfilled). 
