...
ind_files <- dir(file.path(dir_M,"git-annex/globalprep/_raw_data/test_IMAS/d2019"), pattern ="CatchInd", full.names=TRUE)
...
nind_files <- dir(file.path(dir_M,"git-annex/globalprep/_raw_data/test_IMAS/d2019"), pattern ="CatchNInd", full.names=TRUE)
