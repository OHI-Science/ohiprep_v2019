...
cd_2003_2007 <- raster(file.path(outFolder, 'comm_high_bycatch/hb_fish_pressure_2003_2007.tif'))
cd_2004_2008 <- raster(file.path(outFolder, 'comm_high_bycatch/hb_fish_pressure_2004_2008.tif'))
cd_2005_2009 <- raster(file.path(outFolder, 'comm_high_bycatch/hb_fish_pressure_2005_2009.tif'))
cd_2006_2010 <- raster(file.path(outFolder, 'comm_high_bycatch/hb_fish_pressure_2006_2010.tif'))
cd_2007_2011 <- raster(file.path(outFolder, 'comm_high_bycatch/hb_fish_pressure_2007_2011.tif'))
cd_2008_2012 <- raster(file.path(outFolder, 'comm_high_bycatch/hb_fish_pressure_2008_2012.tif'))
cd_2009_2013 <- raster(file.path(outFolder, 'comm_high_bycatch/hb_fish_pressure_2009_2013.tif'))
cd_2010_2014 <- raster(file.path(outFolder, 'comm_high_bycatch/hb_fish_pressure_2010_2014.tif'))
cd_2011_2015 <- raster(file.path(outFolder, 'comm_high_bycatch/hb_fish_pressure_2011_2015.tif'))
all_cd <- stack(cd_2003_2007,cd_2004_2008,cd_2005_2009, cd_2006_2010,cd_2007_2011, cd_2008_2012,cd_2009_2013,  cd_2010_2014,cd_2011_2015)
plot(all_cd, col=cols, axes=FALSE ,box=FALSE)
...
Tidy and create output data
```{r}
data <- merge(rgn_data, regions_stats_hb, all.y=TRUE, by.x="rgn_id", by.y="zone") %>%
...
## combine all years
rasts_art <- list.files(file.path(dir_git,'output/artisanal'), full = TRUE)
