...
Testing `projectRaster` and `projectRaster`+`resample`
```{r}
  
# file = art_land[1] 
# file = comm_disc[1]
# 
# # res 0.5 deg and lat lon crs; rectangular extent
# catch <- raster(file)
# 
# 
# 
# ## METHOD 1: OF PROJECTRASTER(CRS=CRS(NPP), RES=RES(NPP), METHOD=....) 
# ## BUT OVERLAY WON'T WORK BECAUSE 
# # 8.3 by 10,3 km res and mollweide, also double plotting issue over=TRUE supposed to fix
# catch_resample <-  raster("/home/shares/ohi/git-annex/globalprep/prs_fish/v2018/tmp/temp_resample.tif")
# plot(catch_resample)
# catch_resample
# 
# ## METHOD 2: check method of projectRaster then Resample PROJCETRASTER(CRS=CRS(NPP)), RESAMPLE(NPP...)
# ## See if catch_resample2_! changed its resolution; NOPE JUST CONVERTED DEG TO METERS, 
# ## PROJECT RASTER MOLLWEIDE
# catch_resample2_1 <- raster("/home/shares/ohi/git-annex/globalprep/prs_fish/v2018/tmp/temp_resample2-1.tif")
# plot(catch_resample2_1)
# catch_resample2_1
# extent(catch_resample2_1)
# ## RESAMPLE: now CORRECT RES AND MOLL AS NPP NOW TRY OVERLAY!! EXTENT CHANGRED!!!!! now extent same as NPP
# ## NPP IS FUNNY LOOKING, BUT RESAMPLE(NPP) GRABS EXTENT BUT DOESNT DO WEIRD WRAPPING
# catch_resample2_2 <- raster("/home/shares/ohi/git-annex/globalprep/prs_fish/v2018/tmp/temp_resample2-2.tif")
# plot(catch_resample2_2)
# catch_resample2_2
# extent(catch_resample2_2)
# extent(npp) 
# 
# ## METHOD 3: projectraster(npp, method=...) 
# ## matches up extent, matches up res and matches up crs
# ##WTH IT LOOKS FINE.....
# catch_resample_final <- raster(file.path(dir_M,"git-annex/globalprep/prs_fish/v2018/tmp/temp_resample_final.tif"))
# catch_resample_final
# plot(catch_resample_final)
# 
# 
# 
# 
...
# catch_corr_1 <- overlay(catch_resample, npp, fun=function(x,y){x/y}, filename = file.path(dir_M,"git-annex/globalprep/prs_fish/v2018/tmp/temp_corr_1.tif"), overwrite=TRUE)
# 
# ## METHOD 2
# catch_corr_2 <- overlay(catch_resample2_2, npp, fun=function(x,y){x/y}, filename = file.path(dir_M,"git-annex/globalprep/prs_fish/v2018/tmp/temp_corr_2_2.tif"), overwrite=TRUE)
# 
# ## METHOD 3
# catch_corr_final <- overlay(catch_resmp_final, npp, fun=function(x,y){x/y}, filename = file.path(dir_M,"git-annex/globalprep/prs_fish/v2018/tmp/temp_corr_final.tif"), overwrite=TRUE)
# plot(catch_corr_final)
# 
# 
# 
# 
