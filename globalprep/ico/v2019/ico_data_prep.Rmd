...
scenario      <- 'v2019'
previous_scen <- '2018'
source(sprintf('~/github/ohiprep_%s/workflow/R/common.R', scenario))
...
# Need to have ohi-global repo cloned to run the following line:
...
write_csv(ico_list, file.path(dir_goal, 'int/ico_list_prepped.csv')) # 270 in v2019
```
...
### How are we generating this file?? Just copied over from v2018/raw 
