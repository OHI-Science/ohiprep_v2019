...
rgn_iucn2ohi <- read_csv(file.path(dir_github, 'raw/rgns_iucn2ohi.csv'))
### This file is used from year to year and should be copied from previous year.
...
ico_spp_rgn_raw_nas <- ico_spp_rgn_raw %>% 
  filter(is.na(ohi_rgn_name))

#708 NAs under rgn_id, but 597 in ohi_rgn_name
