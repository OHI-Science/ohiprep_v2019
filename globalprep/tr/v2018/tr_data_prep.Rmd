...
Level 2 | 1  | Exercise Increased Caution:  Be aware of heightened risks to safety and security. 
...
These uninhabited regions get cut functions.R.

```{r, eval=FALSE}
georegion_labels <- georegion_labels

##uninhabited regions (no need to worry about these)
uninhabited <- read.csv('https://raw.githubusercontent.com/OHI-Science/ohiprep_v2018/gh-pages/globalprep/supplementary_information/v2018/rgn_uninhabited_islands.csv') %>% 
...
write.csv(no_us_warn, here('globalprep/tr/v2018/intermediate/v2018_no_data.csv'), row.names=FALSE)
