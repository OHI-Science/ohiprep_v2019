...
##### v2019: Duplicates (Guadeloupe/Martinique, PR/VI, China) + didn't create a new file? see notes written at the end of the function script! 
...
#v2019: Guadeloupe + Guadeloupe and Martinique are duplicated here; same with PR/VI ; plus there are a couple of NAs. Put in a line here to remove duplicates and NAs? 
...
# looks like this is still missing 2019 data for some countries (Algeria, Antigua & Barbuda + more)
