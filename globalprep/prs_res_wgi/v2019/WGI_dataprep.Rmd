...
```{r, eval=FALSE}
d <- read.csv('raw/worldbank_wgi_from_wdi_api_2019-03-18.csv') # change appended date 
```
...
old2016 <- read.csv('../v2018/output/wgi_res.csv') %>% # change filepath to the previous assessment year's, rename variable for clarity
  filter(year == 2016) %>%
...
plot(old_score ~ score, data=old2016)
