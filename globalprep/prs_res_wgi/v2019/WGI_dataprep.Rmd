...
```{r, eval=FALSE}
d <- read.csv(here('globalprep/prs_res_wgi/v2019/raw/worldbank_wgi_from_wdi_api_2019-03-18.csv')) # change appended date so that it only changes if you do so actively
...
# Future improvement: create a linear model to estimate missing data rather than just taking averages of years with data
