...
Countries without 4 or more indicator are cut (gapfilled using a different method later).
...
## Safeguard: cut regions with < 4 indicators (if any) to calculate score. No countries were cut in 2018.
