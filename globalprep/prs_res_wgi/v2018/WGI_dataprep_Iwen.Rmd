...
## Take a look at the `d_sovs` data table summary
...
## Take a look at the summary for `d_gf2`
...
old2015 <- read.csv('../v2017/output/wgi_res.csv') %>%
  select(rgn_id, old_score=resilience_score) %>%
  full_join(new2014)

## should be a 1:1 relationship
plot(old_score ~ score, data=old2015)
identify(old2015$score, old2015$old_score, labels = old2015$rgn_id)
abline(0,1, col="red")
