...
# confused because error message is being printed that says lots of species are missing from each group, but d_missing_l is empty? does this mean that these species don't exist in the sp2grp table?
...
# v2018 used write.csv and used argument row.names = FALSE, do we need this if using write_csv? 
