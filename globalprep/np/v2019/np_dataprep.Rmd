...
for (f in files){ # f = files[1]
  ...
  # v2019 duplicates: china, HK SAR, Macao SAR, Guadeloupe, etc - do we need to address these? 
...
hA <- h %>% np_regr_fill(years_back = 10, vars = 'td', scope = 'rgn_id') # fill in NAs with tons~USD model made from data within the region; this only fills in ~540 lines of data 
regr1 <- hA %>% 
