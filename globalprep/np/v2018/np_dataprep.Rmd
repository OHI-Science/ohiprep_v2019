...
# dir_fao_data <- file.path(dir_M, 'git-annex/globalprep/_raw_data/FAO_commodities/d2016/raw')
...
require(gridExtra)
plot1 <- ggplot(old_c, aes(x=year, y=tonnes))+
  geom_point(aes(color=product)) +
  ggtitle("Dominican Republic Commodities (old)") +
  theme_bw()
plot2 <- ggplot(new_c, aes(x=year, y=tonnes))+
  geom_point(aes(color=product)) +
  ggtitle("Dominican Republic Commodities (new)") +
  theme_bw()
...
plot1 <- ggplot(old_c, aes(x=year, y=usd))+
  geom_point(aes(color=product)) +
  ggtitle("old") +
  theme_bw()
plot2 <- ggplot(new_c, aes(x=year, y=usd))+
  geom_point(aes(color=product)) +
  ggtitle("new") +
  theme_bw()
grid.arrange(plot1, plot2, ncol=2)
...
## Look at final smoothed data for Republique du Congo
