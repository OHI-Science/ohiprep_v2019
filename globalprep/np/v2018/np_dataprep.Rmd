...
compare <- old %>% 
full_join(new, by = c("rgn_id","rgn_name","commodity","product","year")); View(compare)
...
compare <- old_c %>% 
  left_join(new_c, by = c("commodity","year","rgn_id","rgn_name","product")); View(compare)
compare_full <- old_c %>% 
  full_join(new_c, by = c("commodity","year","rgn_id","rgn_name","product")); View(compare_full)
...
compare <- old_c %>% 
left_join(new_c, by = c("rgn_id","rgn_name","commodity","product","year")); View(compare)
...
compare2 <- old_tonnes %>% 
  left_join(new_tonnes, by = c("rgn_id","product","year")); View(compare2)
...
compare <- smooth_old %>% 
left_join(smooth_new, by = c("rgn_id","product","year")); View(compare)
