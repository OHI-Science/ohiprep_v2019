...
Then extract catches per OHI regions and standarize by soft-bottom habitat of each region.
Finally, rescale!!!!!!!!!!!!!!!!!
...
=======
  catch_total <- catch_ind %>%
>>>>>>> 0d68442e71cc47057bd498f6faf39c2975d065af
...
str_extract(basename(catch_rasts), "(\\d)+")
...
<<<<<<< HEAD
## Why min of the medianns?? Should it be median??
ref_point_median <- min(ref_median$ref_median) # 0.8590695

median(ref_median$ref_median)

=======
ref_point_median <- min(ref_median$ref_median) 
>>>>>>> 0d68442e71cc47057bd498f6faf39c2975d065af
